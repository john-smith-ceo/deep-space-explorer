...
function planetComposition(t,r){
  const mix = t.k==="gas"   ? [["водород",62,18],["гелий",22,10],["метан",5,4],["аммиак",3,3]]
            : t.k==="ice-g" ? [["водород",42,14],["гелий",16,8],["метан",18,8],["лёд",16,8]]
            : t.k==="ice"   ? [["водяной лёд",54,16],["силикаты",22,10],["аммиачный лёд",12,8],["железо",6,4]]
            : t.k==="ocean" ? [["вода",58,14],["силикаты",24,10],["железо",12,6],["углерод",4,3]]
            : t.k==="lava"  ? [["силикаты",48,12],["железо",30,10],["сера",10,6],["базальт",8,5]]
            : t.k==="iron"  ? [["железо",62,12],["никель",18,8],["силикаты",14,8],["сера",4,3]]
            : t.k==="desert"? [["силикаты",56,12],["железо",20,8],["оксиды",16,8],["углерод",4,3]]
            :                 [["силикаты",52,12],["железо",26,10],["магний",14,8],["углерод",5,4]];
